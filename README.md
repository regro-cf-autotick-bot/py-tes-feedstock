...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/py-tes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11056&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-tes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `py-tes` can be installed with:

```
conda install py-tes
```

It is possible to list all of the versions of `py-tes` available on your platform with:
